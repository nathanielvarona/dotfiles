...
psmux send-keys -t 'dotfiles:0.0' 'nvim .' Enter
# Run list command in bottom 20% pane (1)
psmux send-keys -t 'dotfiles:0.1' 'ls -a' Enter
# Force final cursor focus onto the editor pane
psmux select-pane -t 'dotfiles:0.0'
...
psmux send-keys -t 'dotfiles:1.0' 'lazygit' Enter
# Run version check in bottom 20% pane (1)
psmux send-keys -t 'dotfiles:1.1' 'git --version' Enter

# --- FINAL ATTACH ---
# Switch active view back to the editor window and attach
psmux select-window -t 'dotfiles:0'
